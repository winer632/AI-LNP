"""Structural carrying of the vision relationship enum.

Split from test_merge_vision_observations.py, which covers the abstain
rule for the same module. Two concerns, two files: a failure here means
the relationship declaration stopped being carried or started being
written as text, which is a different defect from an abstention leaking
through as a claim.
"""
